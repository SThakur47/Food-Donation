...
<div class="card-body">
	...
	<div class="form-group">
		...
		<input type="text" name="type" value="doner" hidden="hidden"/>
	
		<div class="form-group">
			<label >Phone Number</label> <input
				type="number" class="form-control" name="phone"
				placeholder="Enter your phone number" required="required" minlength="8">
		</div>
		...
		<div class="form-group">
			<label >Type of Organization</label> <select  class="form-control"
